...
<h1 align="center">
  Trame Digitali starter for Gatsby sites.
</h1>
...
postcss-loader@^4.2.0 should be required if receive an error starting storybook
postcss@^8.0.0

In order to mantain these packages install with --legacy-peer-deps

be carefull: tailwind global css is in src/styles. it should be in every configuration of gatsby, webpack

### styled components and tailwind example
```jsx
